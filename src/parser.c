...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 20:
      ...
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(16);
      if (set_contains(sym_symbol_character_set_1, 10, lookahead)) ADVANCE(25);
      END_STATE();
    case 21:
      ACCEPT_TOKEN(sym_symbol);
      if (lookahead == '+' ||
